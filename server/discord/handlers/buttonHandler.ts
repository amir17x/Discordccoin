  ...
  try {
    ...
    if (action === 'help') {
      ...
      const helpEmbed = new EmbedBuilder()
        ...
        .setDescription('به دنیای مجازی اقتصاد و سرگرمی Ccoin خوش آمدید! در ادامه با بخش‌های مختلف ربات آشنا شوید:')
        .setThumbnail(interaction.client.user?.displayAvatarURL() || '')
        .addFields(
          { 
            name: '💰 **بخش اقتصاد**', 
            value: '`🎁 جایزه روزانه`: دریافت سکه رایگان هر ۲۴ ساعت\n' +
                  '`🏦 سیستم بانکی`: سپرده‌گذاری و دریافت سود ماهانه\n' +
                  '`💱 انتقال سکه`: ارسال سکه به دوستان\n' +
                  '`🕵️‍♂️ سرقت`: تلاش برای دزدیدن سکه از دیگران\n' +
                  '`💎 تبدیل سکه`: تبدیل سکه به کریستال'
          },
          { 
            name: '🎮 **بخش بازی‌ها**', 
            value: '`🎲 بازی‌های انفرادی`: شیر یا خط، سنگ‌کاغذ‌قیچی، حدس عدد\n' +
                  '`👥 بازی‌های رقابتی`: مسابقه با دیگران\n' +
                  '`👪 بازی‌های گروهی`: به زودی...'
          },
          { 
            name: '🛒 **بخش فروشگاه و آیتم‌ها**', 
            value: '`🏪 فروشگاه`: خرید آیتم‌های کاربردی و تزئینی\n' +
                  '`🎒 کوله‌پشتی`: مدیریت آیتم‌های خریداری شده\n' +
                  '`⚡ آیتم‌های ویژه`: خرید با کریستال'
          },
          { 
            name: '📋 **بخش ماموریت‌ها**', 
            value: '`📜 ماموریت روزانه`: وظایف ساده روزانه\n' +
                  '`📚 ماموریت هفتگی`: وظایف بزرگتر هفتگی\n' +
                  '`🏅 دستاوردها`: نشان‌های افتخار'
          },
          { 
            name: '👑 **بخش کلن‌ها**', 
            value: '`🏢 مدیریت کلن`: ساخت و مدیریت کلن\n' +
                  '`👥 عضویت`: پیوستن به کلن‌های موجود\n' +
                  '`🏗️ ساختمان‌ها`: ارتقای کلن با ساخت و ساز\n' +
                  '`⚔️ جنگ کلن‌ها`: رقابت بین کلن‌ها'
          },
          { 
            name: '💹 **بخش سرمایه‌گذاری و درآمدزایی**', 
            value: '`📈 سهام`: خرید و فروش سهام\n' +
                  '`🎟️ قرعه‌کشی`: خرید بلیط برای شانس برنده شدن\n' +
                  '`📊 سرمایه‌گذاری`: سرمایه‌گذاری با ریسک‌های مختلف\n' +
                  '`🎡 چرخ شانس`: چرخش برای دریافت جوایز تصادفی'
          },
          { 
            name: '💡 **نکته‌های مهم**', 
            value: '• برای حفاظت از سکه‌ها، آنها را در بانک نگهداری کنید\n' +
                  '• با افزایش سطح می‌توانید به امکانات بیشتری دسترسی پیدا کنید\n' +
                  '• از طریق ماموریت‌ها می‌توانید سکه و جوایز ویژه دریافت کنید\n' +
                  '• عضویت در کلن به شما امتیازات گروهی می‌دهد'
          }
        )
        .setFooter({ 
          text: 'برای شروع از دستور /menu استفاده کنید | Ccoin Bot v1.5.0', 
