...
export async function mainMenu(
  ...
  try {
    ...
    const embed = new EmbedBuilder()
      ...
      .setThumbnail('https://cdn-icons-png.flaticon.com/512/9041/9041357.png') // آیکون fi-rr-crown برای منوی اصلی
      .setTimestamp();
    ...
    if (!showOther) {
      ...
      embed.setTitle('✨ امکانات بیشتر Ccoin ✨')
        ...
        .setThumbnail('https://cdn-icons-png.flaticon.com/512/9040/9040837.png');  // آیکون fi-rr-sparkles برای منوی امکانات بیشتر
