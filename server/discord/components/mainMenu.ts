  ...
  try {
    ...
    const getPersonalizedMessage = () => {
      ...
      if (user.wallet === 0) {
        ...
        // یک مجموعه از پیشنهادات خلاقانه و هیجان‌انگیز برای خرج کردن پول
        const spendingSuggestions = [
          "🤑 فرصت های سرمایه‌گذاری منتظرته! 📈 به بازار سهام سر بزن!",
          "💰 آماده خرید آیتم‌های خفن هستی؟ 🔮 فروشگاه منتظرته!",
          "🏆 با این همه سکه میتونی تو تورنمنت‌ها غوغا کنی! 🎮",
          "💸 سرمایه خوبی داری! 🏰 میتونی کلن خودت رو بسازی!",
          "🎯 وقتشه تو بازی‌های پرریسک شرکت کنی و سود بیشتری ببری! 🎲",
          "💎 با این سرمایه میتونی کریستال بخری و آیتم‌های نایاب بدست بیاری! ✨",
          "🌟 با این ثروت میتونی به دوستات هدیه بدی و محبوبیتت رو بالا ببری! 🎁"
        ];
