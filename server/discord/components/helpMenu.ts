...
/**
 * ایجاد Embed راهنمای سیستم سهام و بازار
 */
function createStocksHelpEmbed(embed: EmbedBuilder): EmbedBuilder {
  return embed
    .setTitle('📈 راهنمای سیستم سهام و بازار Ccoin ✨')
    .setDescription('آشنایی با سرمایه‌گذاری در بازار سهام، تحلیل بازار، خرید و فروش سهام، و استراتژی‌های سرمایه‌گذاری 💎')
    .setThumbnail('https://img.icons8.com/fluency/48/stocks-growth.png')
    .addFields(
      { 
        name: '💹 **مبانی بازار سهام**', 
        value: '**🔸 بازار سهام چیست؟**: سیستمی برای خرید و فروش سهام شرکت‌های مجازی\n' +
              '**🔸 نوسانات بازار**: تغییرات قیمت سهام به صورت خودکار و براساس الگوریتم‌های واقعی\n' +
              '**🔸 زمان فعالیت**: بازار 24 ساعته فعال است و تغییرات هر 15 دقیقه اعمال می‌شود\n' +
              '**🔸 حداقل سرمایه**: برای شروع به 1000 سکه نیاز دارید\n' +
              '**🔸 کارمزد معاملات**: 1% برای خرید و 0.5% برای فروش',
        inline: false
      },
      { 
        name: '🏢 **شرکت‌های موجود در بازار**', 
        value: '**💻 CCtech**: شرکت فناوری (ریسک متوسط، سود متوسط)\n' +
              '**🏦 CCbank**: شرکت مالی (ریسک کم، سود کم)\n' +
              '**🎮 CCgame**: شرکت بازی‌سازی (ریسک بالا، سود بالا)\n' +
              '**⛽ CCoil**: شرکت انرژی (ریسک متوسط، سود بالا)\n' +
              '**💊 CCmed**: شرکت دارویی (ریسک متغیر، سود متغیر)',
        inline: false
      },
      { 
        name: '💰 **نحوه خرید و فروش سهام**', 
        value: '**🛒 خرید سهام**: از طریق بخش "سهام" در منوی اقتصادی\n' +
              '**💼 فروش سهام**: از طریق بخش "پورتفوی" در پروفایل شخصی\n' +
              '**⏱️ سفارش محدود**: امکان ثبت سفارش برای خرید/فروش در قیمت مشخص\n' +
              '**❌ لغو سفارش**: امکان لغو سفارش‌های ثبت شده قبل از اجرا\n' +
              '**📋 تاریخچه معاملات**: قابل مشاهده در پروفایل شخصی',
        inline: false
      },
      { 
        name: '📊 **تحلیل بازار و نمودارها**', 
        value: '**📅 نمودار روزانه**: بررسی تغییرات قیمت در 24 ساعت گذشته\n' +
              '**📆 نمودار هفتگی**: بررسی تغییرات قیمت در هفته گذشته\n' +
              '**🗓️ نمودار ماهانه**: بررسی تغییرات قیمت در ماه گذشته\n' +
              '**📰 اخبار تأثیرگذار**: اخبار روزانه که بر قیمت سهام تأثیر می‌گذارند\n' +
              '**🏆 رتبه‌بندی تحلیلگران**: بهترین تحلیلگران براساس سود کسب شده',
        inline: false
      },
      { 
        name: '🔍 **استراتژی‌های سرمایه‌گذاری**', 
        value: '**🌱 خرید و نگهداری**: برای کسب سود بلندمدت\n' +
              '**⚡ نوسان‌گیری**: سود از تغییرات کوتاه‌مدت قیمت\n' +
              '**🧩 سبد سهام متنوع**: کاهش ریسک با خرید سهام متنوع\n' +
              '**🤖 معامله خودکار**: تنظیم قوانین خرید و فروش خودکار (نیازمند آیتم ویژه)\n' +
              '**🧠 الگوریتم پیش‌بینی**: کمک هوش مصنوعی برای پیش‌بینی روند بازار (نیازمند کریستال)',
        inline: false
      },
      { 
        name: '🎓 **آموزش و نکات پیشرفته**', 
        value: '**📘 آموزش مبتدی**: آشنایی با مفاهیم اولیه بازار سهام (رایگان)\n' +
              '**📚 آموزش پیشرفته**: آشنایی با تحلیل تکنیکال و فاندامنتال (هزینه: 1000 سکه)\n' +
              '**👨‍🏫 جلسات مشاوره**: مشاوره با تحلیلگران برتر (هزینه: 500 سکه)\n' +
              '**📝 برنامه معاملاتی**: دریافت برنامه پیشنهادی معاملاتی هفتگی (هزینه: 200 سکه)\n' +
              '**👑 گروه VIP**: عضویت در گروه ویژه تحلیل بازار (هزینه: 5000 سکه ماهانه)',
        inline: false
      }
    );
}
...
/**
 * ایجاد Embed راهنمای بازار معاملات کاربران
 */
function createMarketHelpEmbed(embed: EmbedBuilder): EmbedBuilder {
  return embed
    .setTitle('💹 راهنمای بازار معاملات کاربران Ccoin 🛍️')
    .setDescription('آشنایی با بازار معاملات بین کاربران، خرید و فروش آیتم‌ها، مزایده‌ها و نحوه استفاده از سیستم بازار 🌟')
    .setThumbnail('https://img.icons8.com/fluency/48/market-square.png')
    .addFields(
      { 
        name: '🏪 **معرفی بازار کاربران**', 
        value: '**🔹 بازار چیست؟**: پلتفرمی برای خرید و فروش آیتم‌ها بین کاربران\n' +
              '**🔹 مزایای بازار**: قیمت‌گذاری آزاد، تنوع آیتم، معاملات مستقیم\n' +
              '**🔹 ساعات کاری**: 24 ساعته و 7 روز هفته\n' +
              '**🔹 اعتبارسنجی**: تمام معاملات توسط سیستم تأیید می‌شوند\n' +
              '**🔹 کارمزد معاملات**: 5% از مبلغ فروش (از فروشنده کسر می‌شود)',
        inline: false
      },
      { 
        name: '📦 **فروش آیتم در بازار**', 
        value: '**🏷️ نحوه فروش**: از طریق بخش "فروش آیتم" در منوی بازار یا کوله‌پشتی\n' +
              '**💵 تعیین قیمت**: قیمت‌گذاری آزاد با محدودیت حداقل 10 سکه\n' +
              '**⌛ مدت زمان آگهی**: 3 روز (قابل تمدید)\n' +
              '**🔢 حداکثر آیتم قابل فروش**: 5 آیتم همزمان (افزایش با سطح بالاتر)\n' +
              '**❌ لغو آگهی**: امکان حذف آگهی قبل از فروش (بدون هزینه)',
        inline: false
      },
      { 
        name: '🛒 **خرید از بازار**', 
        value: '**🔍 جستجوی آیتم**: امکان جستجو براساس نام، نوع و قیمت\n' +
              '**🔎 فیلترهای پیشرفته**: دسته‌بندی براساس کاربرد، کمیابی و زمان ثبت آگهی\n' +
              '**⚡ خرید فوری**: پرداخت قیمت مشخص شده و دریافت فوری آیتم\n' +
              '**💬 پیشنهاد قیمت**: امکان ارائه پیشنهاد قیمت کمتر به فروشنده\n' +
              '**📋 تاریخچه خرید**: قابل مشاهده در منوی تراکنش‌ها',
        inline: false
      },
      { 
        name: '🔨 **سیستم مزایده**', 
        value: '**🚀 شروع مزایده**: تعیین قیمت پایه و مدت زمان مزایده (12-72 ساعت)\n' +
              '**🎭 شرکت در مزایده**: ارائه پیشنهاد بالاتر از آخرین قیمت پیشنهادی\n' +
              '**📈 حداقل افزایش**: 10% قیمت فعلی یا 50 سکه (هر کدام بیشتر باشد)\n' +
              '**💰 ودیعه**: 10% قیمت پیشنهادی (بازگشت در صورت عدم برنده شدن)\n' +
              '**🏆 برنده مزایده**: پس از اتمام زمان، آیتم به بالاترین پیشنهاددهنده منتقل می‌شود',
        inline: false
      },
      { 
        name: '📋 **انواع معاملات ویژه**', 
        value: '**🔄 معاملات ترکیبی**: امکان مبادله آیتم + سکه\n' +
              '**👑 معاملات VIP**: فروش به لیست محدود از کاربران\n' +
              '**🔮 پیش‌فروش**: فروش آیتم‌های آینده با تخفیف\n' +
              '**⚡ حراج فلش**: فروش با تخفیف ویژه و محدودیت زمانی (1 ساعت)\n' +
              '**👥 فروش گروهی**: تخفیف بر اساس تعداد خریداران',
        inline: false
      },
      { 
        name: '⚠️ **قوانین و امنیت بازار**', 
        value: '**🚫 ممنوعیت‌ها**: فروش آیتم‌های غیرقابل انتقال، کلاهبرداری و تبانی\n' +
              '**⭐ سیستم اعتبارسنجی**: رتبه‌بندی کاربران براساس فعالیت در بازار\n' +
              '**🚨 گزارش تخلف**: امکان گزارش آگهی‌های مشکوک\n' +
              '**⚖️ حل اختلاف**: بررسی اختلافات توسط تیم پشتیبانی\n' +
              '**🔒 امنیت پرداخت**: انجام معامله از طریق سیستم واسط (نه مستقیم بین کاربران)',
        inline: false
      }
    );
}
...
/**
 * ایجاد Embed راهنمای رویدادها و قرعه‌کشی‌ها
 */
function createEventsHelpEmbed(embed: EmbedBuilder): EmbedBuilder {
  return embed
    .setTitle('🎉 راهنمای رویدادها و قرعه‌کشی‌های Ccoin 🎊')
    .setDescription('آشنایی با انواع رویدادها، قرعه‌کشی‌ها، جوایز ویژه و نحوه شرکت در آنها ✨')
    .setThumbnail('https://img.icons8.com/fluency/48/event-accepted.png')
    .addFields(
      { 
        name: '🎲 **قرعه‌کشی‌های روزانه**', 
        value: '**🎫 نحوه شرکت**: خرید بلیط قرعه‌کشی (100 سکه)\n' +
              '**⏰ زمان قرعه‌کشی**: هر 24 ساعت یکبار\n' +
              '**🏆 جوایز**: 3000 سکه (نفر اول)، 1000 سکه (نفر دوم)، 500 سکه (نفر سوم)\n' +
              '**🔢 حداکثر بلیط**: 5 بلیط روزانه برای هر کاربر\n' +
              '**🍀 شانس برد**: با هر بلیط، 5%',
        inline: false
      },
      { 
        name: '🎪 **رویدادهای فصلی**', 
        value: '**🌸 بهار**: جشنواره نوروز - جوایز ویژه و دکوراسیون‌های سفره هفت‌سین\n' +
              '**☀️ تابستان**: المپیک تابستانی - مسابقات ویژه با جوایز کریستالی\n' +
              '**🍁 پاییز**: جشن مهرگان - تخفیف‌های ویژه و آیتم‌های محدود\n' +
              '**❄️ زمستان**: جشن یلدا و کریسمس - هدایای روزانه و قرعه‌کشی‌های ویژه',
        inline: false
      },
      { 
        name: '🎡 **چرخ و فلک شانس**', 
        value: '**💵 هزینه**: 50 سکه برای هر چرخش\n' +
              '**🎁 جوایز**: سکه (10-1000)، کریستال (1-10)، آیتم‌های کمیاب و ویژه\n' +
              '**🆓 چرخش رایگان**: یک بار در روز\n' +
              '**✨ چرخش ویژه**: بعد از 10 چرخش عادی، یک چرخش با جایزه تضمینی ویژه\n' +
              '**💯 تخفیف گروهی**: چرخش 10 تایی = 450 سکه (10% تخفیف)',
        inline: false
      },
      { 
        name: '🏆 **تورنمنت‌های ویژه**', 
        value: '**🌙 تورنمنت ماهانه**: رقابت در بازی‌های مختلف با جوایز 10,000+ سکه\n' +
              '**🥇 لیگ طلایی**: رقابت هفتگی بین بهترین بازیکنان با پاداش کریستال\n' +
              '**🌐 مسابقات سرور**: رقابت بین سرورهای مختلف و جوایز گروهی\n' +
              '**👑 تورنمنت VIP**: مخصوص اعضای ویژه با جوایز منحصر به فرد\n' +
              '**🏰 تورنمنت کلن‌ها**: رقابت بین کلن‌های برتر با جوایز برای تمام اعضای کلن',
        inline: false
      },
      { 
        name: '🎭 **رویدادهای ویژه**', 
        value: '**🍉 شب یلدا**: هدایای ویژه، دکوراسیون‌های فصلی و آیتم‌های محدود\n' +
              '**🎂 سالگرد ربات**: جوایز ویژه برای تمام کاربران و تخفیف‌های استثنائی\n' +
              '**🚀 جشن صد هزار کاربر**: رویداد ویژه با جوایز خاص و آیتم‌های کلکسیونی\n' +
              '**🎮 هفته گیمرها**: مسابقات ویژه بازی‌ها با جوایز دو برابر\n' +
              '**☪️ ماه رمضان**: پاداش‌های روزانه افطار و سحر، آیتم‌های مخصوص ماه رمضان',
        inline: false
      },
      { 
        name: '🎁 **جک‌پات‌ها و جوایز کلان**', 
        value: '**💸 جک‌پات هفتگی**: قرعه‌کشی بزرگ با جایزه 50,000 سکه\n' +
              '**💎 جک‌پات ماهانه**: قرعه‌کشی ویژه با جایزه 200,000 سکه و 100 کریستال\n' +
              '**👑 جوایز VIP**: جوایز ویژه برای اعضای VIP با شانس برد بیشتر\n' +
              '**👥 جایزه ریفرال**: پاداش برای معرفی دوستان به ربات\n' +
              '**🔥 جایزه فعالیت**: پاداش ویژه برای کاربران فعال هفتگی و ماهانه',
        inline: false
      }
    );
}
...
/**
 * ایجاد Embed راهنمای سیستم شخصی‌سازی
 */
function createProfileHelpEmbed(embed: EmbedBuilder): EmbedBuilder {
  return embed
    .setTitle('⚙️ راهنمای سیستم شخصی‌سازی Ccoin 🎨')
    .setDescription('آشنایی با روش‌های شخصی‌سازی پروفایل، تنظیمات اعلان‌ها و سفارشی‌سازی تجربه کاربری ✨')
    .setThumbnail('https://img.icons8.com/fluency/48/settings.png')
    .addFields(
      { 
        name: '👤 **شخصی‌سازی پروفایل**', 
        value: '**🖼️ بنر پروفایل**: تغییر تصویر پس‌زمینه پروفایل (هزینه: 500 سکه)\n' +
              '**📝 عنوان سفارشی**: انتخاب عنوان نمایشی (هزینه: 250 سکه)\n' +
              '**🎨 رنگ نام**: تغییر رنگ نام در چت و پروفایل (هزینه: 750 سکه)\n' +
              '**🏅 نماد‌های تزئینی**: افزودن آیکون‌های ویژه کنار نام (نیازمند دستاوردهای خاص)\n' +
              '**🖼️ قاب پروفایل**: تغییر قاب دور تصویر پروفایل (هزینه: 1000 سکه)',
        inline: false
      },
      { 
        name: '📱 **تنظیمات اعلان‌ها**', 
        value: '**📆 اعلان‌های روزانه**: یادآوری دریافت جایزه روزانه و مأموریت‌ها\n' +
              '**💹 اعلان‌های معاملات**: اطلاع‌رسانی خرید، فروش و پیشنهادات بازار\n' +
              '**👥 اعلان‌های دوستی**: درخواست‌های دوستی و هدایای دریافتی\n' +
              '**🎉 اعلان‌های رویدادها**: اطلاع از شروع رویدادها و قرعه‌کشی‌ها\n' +
              '**🔔 اعلان‌های سیستمی**: به‌روزرسانی‌ها، تعمیرات و اخبار مهم ربات',
        inline: false
      },
      { 
        name: '🌐 **زبان و محلی‌سازی**', 
        value: '**🗣️ زبان رابط کاربری**: انتخاب بین فارسی و انگلیسی\n' +
              '**📅 فرمت تاریخ و زمان**: شمسی یا میلادی\n' +
              '**💰 واحد پول**: نمایش به صورت عددی یا متنی (هزار/میلیون)\n' +
              '**🗓️ تقویم**: انتخاب بین تقویم شمسی یا میلادی برای رویدادها\n' +
              '**💬 لحن پیام‌ها**: تنظیم سبک نوشتاری ربات (رسمی/دوستانه)',
        inline: false
      },
      { 
        name: '🎨 **تم و ظاهر**', 
        value: '**🌈 تم رنگی**: انتخاب از بین 10 تم رنگی مختلف\n' +
              '**📋 سبک منو**: کلاسیک، مدرن یا مینیمال\n' +
              '**📝 نوع فونت**: انتخاب از بین فونت‌های مختلف (برای فارسی و انگلیسی)\n' +
              '**🌓 حالت تاریک/روشن**: تنظیم خودکار براساس زمان یا انتخاب دستی\n' +
              '**✨ انیمیشن‌ها**: فعال/غیرفعال کردن انیمیشن‌های رابط کاربری',
        inline: false
      },
      { 
        name: '🔔 **اعلان‌های شخصی**', 
        value: '**⏰ یادآوری سفارشی**: تنظیم یادآوری برای فعالیت‌های مختلف\n' +
              '**📨 اعلان خصوصی**: ارسال پیام‌های یادآوری به DM\n' +
              '**📈 اعلان بازار**: تنظیم هشدار برای قیمت‌های خاص در بازار سهام\n' +
              '**📊 گزارش هفتگی**: دریافت خلاصه فعالیت‌های هفتگی\n' +
              '**👥 اطلاع‌رسانی دوستان**: آگاهی از آنلاین شدن دوستان خاص',
        inline: false
      },
      { 
        name: '📊 **آمار و گزارش‌ها**', 
        value: '**🎮 آمار بازی‌ها**: مشاهده عملکرد در انواع بازی‌ها\n' +
              '**📜 تاریخچه معاملات**: گزارش کامل خرید و فروش‌ها\n' +
              '**📉 تحلیل درآمد**: نمودار درآمد و هزینه‌های روزانه/هفتگی\n' +
              '**🏆 رتبه‌بندی سراسری**: مشاهده جایگاه خود در بین تمام کاربران\n' +
              '**🌟 پیشرفت دستاوردها**: درصد تکمیل دستاوردها و چالش‌ها',
        inline: false
      }
    );
}
...
export async function searchHelp(interaction: ButtonInteraction | ChatInputCommandInteraction, query: string) {
  try {
    ...
    // بررسی عبارت در راهنمای هوش مصنوعی
    if (searchTerm.includes('هوش') || searchTerm.includes('مصنوعی') || 
        searchTerm.includes('ccoin ai') || searchTerm.includes('تصویر') || 
        searchTerm.includes('کد') || searchTerm.includes('برنامه‌نویسی') ||
        searchTerm.includes('محتوا') || searchTerm.includes('آموزش') ||
        searchTerm.includes('تحلیل')) {
      results.push({
        category: 'ai',
        title: '🧠 هوش مصنوعی CCOIN AI',
        content: 'گفتگوی هوشمند، تحلیل تصویر، تولید محتوا، کمک در برنامه‌نویسی و آموزش'
      });
    }
    
    // بررسی عبارت در راهنمای سیستم سهام
    if (searchTerm.includes('سهام') || searchTerm.includes('بورس') || 
        searchTerm.includes('سرمایه') || searchTerm.includes('بازار') || 
        searchTerm.includes('خرید و فروش') || searchTerm.includes('نمودار') ||
        searchTerm.includes('شرکت') || searchTerm.includes('قیمت')) {
      results.push({
        category: 'stocks',
        title: '📈 سیستم سهام و بازار',
        content: 'سرمایه‌گذاری در بازار سهام، تحلیل بازار و استراتژی‌های سرمایه‌گذاری'
      });
    }
    
    // بررسی عبارت در راهنمای بازار معاملات
    if (searchTerm.includes('بازار') || searchTerm.includes('معامله') || 
        searchTerm.includes('مزایده') || searchTerm.includes('حراج') || 
        searchTerm.includes('فروش') || searchTerm.includes('خرید') ||
        searchTerm.includes('آگهی') || searchTerm.includes('قیمت') ||
        searchTerm.includes('آیتم') || searchTerm.includes('کالا')) {
      results.push({
        category: 'market',
        title: '💹 بازار معاملات کاربران',
        content: 'خرید و فروش آیتم‌ها بین کاربران، مزایده‌ها و معاملات ویژه'
      });
    }
    
    // بررسی عبارت در راهنمای رویدادها
    if (searchTerm.includes('رویداد') || searchTerm.includes('قرعه‌کشی') || 
        searchTerm.includes('جایزه') || searchTerm.includes('بلیط') || 
        searchTerm.includes('جشن') || searchTerm.includes('فصلی') ||
        searchTerm.includes('چرخ و فلک') || searchTerm.includes('تورنمنت') ||
        searchTerm.includes('جک‌پات') || searchTerm.includes('یلدا')) {
      results.push({
        category: 'events',
        title: '🎉 رویدادها و قرعه‌کشی‌ها',
        content: 'رویدادهای ویژه، قرعه‌کشی‌ها، چرخ و فلک شانس و تورنمنت‌ها'
      });
    }
    
    // بررسی عبارت در راهنمای شخصی‌سازی
    if (searchTerm.includes('پروفایل') || searchTerm.includes('شخصی‌سازی') || 
        searchTerm.includes('تنظیمات') || searchTerm.includes('اعلان') || 
        searchTerm.includes('تم') || searchTerm.includes('زبان') ||
        searchTerm.includes('رنگ') || searchTerm.includes('آمار') ||
        searchTerm.includes('گزارش') || searchTerm.includes('بنر')) {
      results.push({
        category: 'profile',
        title: '⚙️ سیستم شخصی‌سازی',
        content: 'شخصی‌سازی پروفایل، تنظیمات اعلان‌ها، تم و رابط کاربری'
      });
    }
