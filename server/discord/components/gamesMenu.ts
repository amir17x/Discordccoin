...
export async function gamesMenu(
  ...
  try {
    ...
    const embed = new EmbedBuilder()
      ...
      .setThumbnail('https://cdn-icons-png.flaticon.com/512/8768/8768770.png') // آیکون fi-sr-gamepad برای بخش بازی ها
      .addFields(
    ...
    if (state === 'solo') {
      ...
      embed.setColor('#27AE60') // رنگ سبز برای بازی‌های تک‌نفره (ساده و سرگرم‌کننده)
        ...
        .setThumbnail('https://cdn-icons-png.flaticon.com/512/8768/8768770.png'); // همان آیکون fi-sr-gamepad برای بازی‌های تک‌نفره
      ...
      embed.setColor('#E74C3C') // رنگ قرمز روشن برای نشان دادن هیجان رقابت
        ...
        .setThumbnail('https://cdn-icons-png.flaticon.com/512/8768/8768770.png') // همان آیکون fi-sr-gamepad برای بخش بازی‌های رقابتی
        .setFields(
      ...
      embed.setColor('#9B59B6') // رنگ بنفش برای بازی‌های گروهی
        ...
        .setThumbnail('https://cdn-icons-png.flaticon.com/512/8768/8768770.png') // همان آیکون fi-sr-gamepad برای بخش بازی‌های گروهی
        .setFields(
