...
export async function generateAIResponse(
  ...
  try {
    ...
    const errorResponses = [
      ...
      "AI ما رفته تعطیلات کوتاه مدت! 🏝️ این بهترین زمان برای سرمایه‌گذاری در بازار سهامه! 📈",
      "دستیار هوشمند در حال خواب عمیقه! 💤 چطوره توی این فاصله در قرعه‌کشی‌های لوکس شرکت کنی؟ 🎟️",
      "هوش مصنوعی در حال ارتقاء به نسخه جدیدتره! 🚀 تا بیاد، با قابلیت جهان‌های موازی خوش بگذرون! 🌀",
      "CCOIN AI داره استراتژی‌های جدید یاد می‌گیره! 🧠 الان وقت خوبیه برای پت‌های مجازی خودت رو تقویت کنی! 🐾",
      "سرورهای AI ما در حال تنفس عمیق هستن! 🌬️ فرصت عالی برای آپگرید کردن آیتم‌های کوله‌پشتیت! 🎒✨",
      "هوش مصنوعی فعلاً مشغول حل مسائل پیچیده کیهانیه! 🌌 چرا توی این فاصله دوستات رو به کلنت دعوت نمی‌کنی؟ 👥",
      "CCOIN AI برای شارژ مجدد رفته به خواب زمستانی! ❄️ شرط می‌بندم می‌تونی رکورد امتیاز رو توی گرگینه بشکنی! 🐺"
    ];
